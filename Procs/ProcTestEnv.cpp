...
int main(){
    ...
    // EvalResult res;
    // res.constructRValueByObject(new Str("StrA"));
    // LOG << res << endl;

    // IObject* str2 = new Str("StrB");
    // EvalResult res2;

    // Variable varA = Variable();
    // varA.constructByObject(str2);
    ...
    // Scope prScope, scope;
    // scope.parent = &prScope;

    // prScope.constructVariable("stra", "str");
    // LOG << *scope.getVariable("stra") << endl;
    // scope.setVariable("stra", new Str("42"));
    // LOG << *scope.getVariable("stra") << endl;
