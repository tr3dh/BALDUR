...
I would also like to thank the respective developers and maintainers of the open-source libraries and the designers of the open-source assets used in the project.
