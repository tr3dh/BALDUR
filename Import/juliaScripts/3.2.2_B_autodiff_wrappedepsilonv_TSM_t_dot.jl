...
function autodiff_epsilonv_TSM_t_dot(d, dd1_dXi1, Xi, dd2_dXi2, dd3_dXi3)
...
start_time = time()
res = autodiff_epsilonv_TSM_t_dot(rand(), rand(3, 3), rand(3, 3), rand(3, 3, 3, 3), rand(3, 3, 3, 3, 3, 3))
