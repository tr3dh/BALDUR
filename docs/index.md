...
The included [master's thesis](https://github.com/tr3dh/BALDUR/blob/main/Recc/Thesis/Masterthesis_Rother_2026_public.pdf) provides an easy introduction using clear examples and references to the Alberich base language and the Baldur distribution. The [language examples](https://github.com/tr3dh/BALDUR/blob/main/Examples/) also provide a suitable foundation for getting started. The Language Support can also be consulted to explore implemented functions, operators, variables, and more.
...
These are listed below. The corresponding license texts are stored in the [thirdPartyLicenses](https://github.com/tr3dh/BALDUR/blob/main/thirdPartyLicenses/) folder.
